        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <section style="padding: 20px;">
                ...
                <!-- Lista de profesores -->
                    ...
                    <h1><b>Lista de profesores</b><a href="print/profesor-print-excel.php" id="print-excel-admin" style="float: right; margin-left: 15px; margin-right: 50px;">Excel <i class="fa-solid fa-file-excel"></i></a> <a href="print/profesor-print-pdf.php" id="print-pdf-admin" style="float: right;">PDF <i class="fa-solid fa-file-pdf"></i></a></h1>
                    ...
                    <div id="hr-vertical1">
                        ...
                        <form action="../app/user-edit.php" method="post" id="form-admin" style="margin-left: 35px;">
                            ...
                            <input type="text" name="rol" id="rol" maxlength="30"><br><br>
