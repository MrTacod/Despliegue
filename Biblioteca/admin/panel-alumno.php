        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <section style="padding: 20px;">
                ...
                <!-- Lista de alumnos -->
                    ...
                    <h1><b>Lista de alumnos</b><a href="print/alumno-print-excel.php" id="print-excel-admin" style="float: right; margin-left: 15px; margin-right: 50px;">Excel <i class="fa-solid fa-file-excel"></i></a> <a href="print/alumno-print-pdf.php" id="print-pdf-admin" style="float: right;">PDF <i class="fa-solid fa-file-pdf"></i></a></h1>
