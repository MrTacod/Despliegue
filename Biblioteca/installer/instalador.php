        ...
        <div class="form-container">
            ...
            <form action="acceso.php" method="post" class="signin-form needs-validation" novalidate>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" class="form-control" id="repetir-contrasena" name="repetir-contrasena" placeholder="escriba de nuevo la contraseña" required maxlength="12" pattern="[A-Za-z0-9!_.?$]{7,20}">
                    <div class="valid-feedback">Campo OK</div>
