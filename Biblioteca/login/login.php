...
<body class="full-cover-background" style="background-image:url(assets/img/font-login.jpg);">
    <div class="form-container">
        ...
        <form action="../app/comprobar-login.php" method="post" class="signin-form needs-validation" novalidate>
        ...
        <div>
            ...
            <a href="./registro.php" class="btn btn-white text-danger">Regístrate aquí</a>
        </div>
